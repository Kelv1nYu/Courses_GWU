...
print("super smart" if grade == "A" else "smart" if grade == "A-" else "not bad" if grade == "B+" else "could be better" if grade == "B" else "just fine" if grade == "B-" else "no idea" )

incomelevel = "super smart" if grade == "A" else "smart" if grade == "A-" else "not bad" if grade == "B+" else "could be better" if grade == "B" else "just fine" if grade == "B-" else "no idea" 
print(incomelevel)
...
for key, val in { "k0":4, "k8":'2', "k1":("a",5), "k5":'end' }.items() :
...
fh = open('presidents.txt') # fh stands for file handle
